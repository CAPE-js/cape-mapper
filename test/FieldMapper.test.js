...
describe('FieldMapper', () => {
  describe('constructor', () => {
    ...
    test('When source_headings is a list including "AUTO": an error is thrown', () => {
      expect(() => {
        /* eslint-disable no-unused-vars */
        // noinspection JSUnusedLocalSymbols
    ...
    test('When multiple is not set: multiple defaults to false', () => {
      const fieldMapper = new FieldMapper({ id: 'Title', label: 'Title' })
  ...
  describe('process_single_raw_value()', () => {
    ...
    test('When an string of over 10 characters is processed by a date field mapper: it returns only the first 10 characters', () => {
